 ...
 */
export const releasePartnerMargins = functions.pubsub
  .schedule('0 0 * * *')
  .timeZone('Asia/Kolkata')
  .onRun(async (context) => {
 ...
 */
export const checkPartnerActivity = functions.pubsub
 ...
 */
export const processPartnerOrder = functions.firestore
 ...
 */
export const handleOrderDelivery = functions.firestore
  .document('partnerOrders/{orderId}')
  .onUpdate(async (change, context) => {
 ...
 */
export const createDefaultPartnerMargins = functions.https.onCall(async (data, context) => {
  // Verify admin
